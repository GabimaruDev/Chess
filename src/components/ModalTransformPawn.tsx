...
const ModalTransformPawn: FC<ModalTransformPawnProps> = (props) => {
  ...
  const footer = (
    <>
      <button
        className="btn"
        onClick={() => handleAdvancedPawn(FigureNames.QUEEN, board.advancedPawnCell?.figure?.color)}
      >
        <img
          src={
      ...
      <button
        className="btn"
        onClick={() => handleAdvancedPawn(FigureNames.ROOK, board.advancedPawnCell?.figure?.color)}
      >
        <img
          src={
            board.advancedPawnCell?.figure?.color === Colors.BLACK ? rookLogoBlack : rookLogoYellow
          }
          width={sizeImg}
          height={sizeImg}
          alt="rook"
